...
<head>
    ...
    <link rel="shorcut icon" type="image" href="./Image/logo_200x200-1.png">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto" style="flex-basis: 70%">
                ...
                <li class="nav-item dropdown">
                    <a style="color:bisque" class="nav-link" href="display_all.php" id="navbarDropdown" role="button"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#footer" style="color:bisque">Liên hệ</a>
                </li>
                <li class="nav-item" style="font-family:monospace;">
                    <a class="nav-link" href="cart.php" style="color:bisque"><img
            ...
            <form action="search_product.php" method="get" class="form-inline my-1 my-lg-0 d-flex"
                ...
                <input type="search" name="search_data" style="margin-right: 15px" class="form-control me-2"
                    placeholder="Tìm kiếm sản phẩm" aria-label="Search">
                <input name="search_data_product" class="btn btn-outline-success my-2 my-sm-0" type="submit"
                    value="Tìm kiếm"><?php search_product(); ?>
            </form>
        </div>
    </nav>
    <!--gọi hàm cart-->
  ...
  ?>
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
      ...
      if (!isset($_SESSION['username'])) {
        ...
        echo "
        <li class='nav-item'>
        <a style='cursor: default' class='nav-link'>Chào mừng " . $_SESSION['username'] . "</a>
        </li>  
        <li class='nav-item'>
        <a class='nav-link' href='./user_area/profile.php'>Trang cá nhân</a>
        </li>     
        <li class='nav-item'>
    ...
    <div class="row">
        <!-- thanh điều hướng -->
        <div class="col-md-2 bg-dark p-0" style="margin-left: 20px">
            <ul class="navbar-nav me-auto text-center">
                <li class="nav-item bg-success">
                    <a href="#" class="nav-link text-light" style="font-family:monospace">
                        <h4 style="font-family:monospace">Thương hiệu</h4>
                    </a>
                </li>
                <?php
        getbrands();
        ?>
            ...
            <ul class="navbar-nav me-auto text-center">
                <li class="nav-item bg-success">
                    <a href="#" class="nav-link text-light" style='font-family:monospace'>
                        <h4 style="font-family:monospace">Danh mục sản phẩm</h4>
                    </a>
                </li>
                <?php
        getcategories();
...
<!--footer -->
<div id="footer" style="background-color: rgb(34, 24, 24); font-family:monospace, Helvetica, sans-serif; color: white"
    ...
    <div class="col" style="display: collumn; margin-left: 25px; text-align:justify;">
        ...
        <iframe
            ...
            width="250" height="250" style="border:1;" allowfullscreen="" loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
<div style="background-color: rgb(34, 24, 24); font-family:monospace, Helvetica, sans-serif; color: white"
    class=" bg-dark row mt-0 p-3 text-center">
    <h4>Design By @BML - 2023</h4>
</div>
