...
<body>
   ...
   <a href="index.php"><img src="./Image/logo_200x200-1.png" style="height: 100px; width: 100px;margin-right: 15px"></a> 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form action="search_product.php" method="get" class="form-inline my-1 my-lg-0 d-flex" style="margin-right: 45px;flex-basis: 30%" >
        <input type="search" name="search-data" style="margin-right: 20px" class="form-control me-2" placeholder="Tìm kiếm sản phẩm" aria-label="Search">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <ul class="navbar-nav me-auto">
      <li class="nav-item">
        <a class="nav-link" style="color:bisque">Chào mừng</a>
      </li>
      <?php 
      if(!isset($_SESSION['username'])){
        ...
        echo"
        <li class='nav-item'>
        <a class='nav-link'>Chào mừng ".$_SESSION['username']."</a>
        </li>
        <li class='nav-item'>
  ...
  <div class="row">
    <!-- thanh điều hướng -->
    <div class="col-md-2 bg-primary p-0" style="margin-left: 20px">
