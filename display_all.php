  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color:  rgb(34, 24, 24); font-family:monospace, Helvetica, sans-serif;">
   <a href="index.php"><img src="./Image/logo_200x200-1.png" style="height: 100px; width: 100px;margin-right: 15px"></a> 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-1 my-lg-0 d-flex" style="margin-right: 45px;flex-basis: 30%" action="search_product.php" method="get">
        <input type="search" name="search-data" style="margin-right: 20px" class="form-control me-2" placeholder="Tìm kiếm" aria-label="Search">
        <input class="btn btn-outline-success my-2 my-sm-0" type="submit" name="search-data-product" value="Tìm">
      </form>
    </div>
  </nav>
  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="row px-1">
        ...
        <!--footer -->
        <!--footer -->
<div id="footer" style="background-color: rgb(34, 24, 24); font-family:monospace, Helvetica, sans-serif; color: white" class="row mt-3 p-3 text-center">
